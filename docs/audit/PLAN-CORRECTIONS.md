...
Périmètre : branche `claude/corrigenda-audit-check-w1m6fy` (PR #54). Aucun merge sur main.
Statut : plan validé, exécution PAS encore commencée — aucune des corrections F1-F37 n'est appliquée.
